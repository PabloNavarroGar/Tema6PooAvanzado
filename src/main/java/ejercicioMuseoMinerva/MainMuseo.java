...
public class MainMuseo {
    ...
    public static void main(String[] args) {
        ...
        Obra o3 = new Cuadro("Los Padros", EpocasObras.CONTEMPORANEO, "Pabloski");
        ...
        if (e3 instanceof Pintorisco) {
            ((Pintorisco) e3).restaurarUnaObra(o3);

        }
        // Una interfaz puede tener atributos 
        // Atributos de Instancia y de clase
        // Por defecto los metodos d elas interfaces son public y static
