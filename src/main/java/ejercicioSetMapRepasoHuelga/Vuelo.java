...
public class Vuelo {
    ...
    private List<Pasajero1> listadoPasajeros;
...
/*
    ...
    */
    ...
    public Vuelo(int codVuelo, String origen, String destino, double duracion, List<Pasajero1> listadoPasajeros) {
    ...
    public List<Pasajero1> getListadoPasajeros() {
        return listadoPasajeros;
    }

    public void setListadoPasajeros(List<Pasajero1> listadoPasajeros) {
        this.listadoPasajeros = listadoPasajeros;
    }
